...
- Deadline/reference calibration must not depend on the proposed novel algorithm.
...
- `generator/` - deterministic dataset generator.
...
2. Implement deterministic generation and validation.
3. Generate candidate instances.
4. Validate distributions, feasibility, and reproducibility.
5. Freeze a version before running/tuning the proposed algorithm.
