...
- The `full-pilot-materialization` workflow generates and fully validates all 200 frozen pilot inputs, reports complete payload sizing/degeneracy, and uploads a short-retention review artifact. Superseded PR runs are cancelled by concurrency guards.
